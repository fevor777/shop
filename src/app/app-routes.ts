...
export default [
    ...
    {   
        path: 'cart', 
        loadComponent: () => import('./cart/component/cart-list/cart-list.component').then(mod => mod.CartListComponent) 
    },
    {
        path: 'order',
        canActivate: [IsCartEmptyGuard],
        loadComponent: () => import('./order/process-order.component').then(mod => mod.ProcessOrderComponent)
    },
    {
        path: 'admin',
        canLoad: [AdminGuard],
